...
export default class CartComp extends Leact{
    constructor(){
        super();
        //console.log(document.querySelector('browser-router').shadowRoot.querySelector('nav-bar'))
        this.state = {
            cartcount: document.querySelector('browser-router').shadowRoot.querySelector('nav-bar').state.cartcount
        }
    ...
    render(){
        ...
        <div class='cart'>
            <div class='cart-content'>
                <div style="display: flex;justify-content: space-between;align-items:center;box-shadow: 0 0 6px 3px rgba(0, 0, 0, 0.05);padding: 10px;height:40px">
                    <div style="">Cart(${this.state.cartcount})</div>
        ...
        this.shadowRoot.querySelector("#closebtn").addEventListener("click",(e)=>{
            ...
            // navbar.setState({showCart:false})
